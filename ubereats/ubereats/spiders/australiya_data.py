...
page_save1 = "E:\\uberetas pagesave\\australiya_april\\"

class InstaDataSpider(scrapy.Spider):
    name = 'australiya_data'
    i = 1
    handle_httpstatus_list = [404, 410, 401]

    db_name = dbc.db_name
    cur = db_name['link_AU']
    cur2 = db_name['Data_AU']
    ...
    def start_requests(self):
        ...
        for link in urls[int(self.a):int(self.b)]:
            ...
            # url1 = 'https://www.ubereats.com/au/store/pattysmiths-dickson/1x1PdWV_SsuVZ0L7Mg9IQQ'
            ...
            yield scrapy.FormRequest(url=link, method='get', callback=self.get_res_detail, headers=header,
                                     meta={'delivery': delivery_time, 'offer': offer, 'delivery_fee': delivery_fee,'links': url1},
                                     dont_filter=True)
           ...
           pass
            ...
            try:
                ...
                if content['stores']:
                    ...
                    try:
                        link = links.split("https://www.ubereats.com/au/")[1]
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl australiya_data -a a=0 -a b=10000'.split())
