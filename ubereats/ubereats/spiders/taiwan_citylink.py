...
class UberCitySpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        link='https://www.ubereats.com/tw/location'
    ...
    def get_city(self,response):
        ...
        links = response.xpath('//h2[contains(text(),"附近城市")]/../../following-sibling::div//a//@href').getall()
        for link in links:
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl taiwan_citylink'.split())
